    ...
    <div class="row " >
        <div class="col-md-12">
            <div class="content-panel">
                <h4 style="text-decoration: underline" class="text-primary"><a href="{{route('indexFormuleAdmin')}}" data-toggle="tooltip" data-placement="bottom" title="Retour"><i class="fa fa-arrow-left"></i></a> Edition formule</h4>
                <div class="row">
                    ...
                    <div class="col-lg-6 col-lg-offset-3">
                        ...
                        <form role="form" method="post">
                            ...
                            <div class="form-group input-group">
                                ...
                                <span class="input-group-addon" id="colorIndicator" style="background-color: @isset($color){{$color}} @endisset"></span>
                            </div>
                            <div class="form-group" >
                                <label class="control-label col-lg-4">Fonctionnalités</label>
                                <div class="col-lg-8"></div>
                                <select id="description" name="description[]" required data-placeholder="ajouter des description"  class="form-control chzn-select" multiple="multiple" tabindex="4" style="height:25px;">
                                    @foreach($listes as $object)
                                        <option value="{{$object->id}}"  @foreach($formule->descriptions as $descript) @if($descript->id==$object->id) selected @endif @endforeach>{{$object->libelle}}</option>
                                    @endforeach
                                </select>
                            </div>
