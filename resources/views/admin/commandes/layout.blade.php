...
">
        <a href="{{route('indexLangue')}}" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
            <i class="icon-tasks"> </i> Démarrage Projets

            <span class="pull-right">
                          <i class="icon-angle-left"></i>
                        </span>
            &nbsp; <span class="label label-default">{{$GlobalNbrDemarrage}}</span>&nbsp;
        </a>
    </li>
    <li class="panel">
        <a href="{{route('indexLangue')}}" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
            <i class="icon-tasks"> </i>Projets

            <span class="pull-right">
                          <i class="icon-angle-left"></i>
                        </span>
            &nbsp; <span class="label label-default">{{$GlobalNbrProjets}}</span>&nbsp;
        </a>
    </li>
    <li class="panel active">
        <a href="{{route('indexLangue')}}" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
            <i class="icon-tasks"> </i>Commandes

            <span class="pull-right">
                          <i class="icon-angle-left"></i>
                        </span>
            &nbsp; <span class="label label-default">{{$GlobalNbrCommande}}</span>&nbsp;
        </a>
    </li>
@endsection