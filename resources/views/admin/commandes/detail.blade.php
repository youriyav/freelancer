...
@section('content_main')
    <div class="row " style="margin-top: 10px">
        <p style="padding: 10px"><a href="{{route('indexProjet',["joour"=>"today"])}}" ><i class="fa fa-arrow-left fa-2x"></i></a></p>
        <div class="col-md-12">
                ...
                <div class="panel projet col-lg-10 col-lg-offset-1" style="padding-bottom: 10px;padding-top: 10px">
                    ...
                    <div class="panel-heading" style="margin: 0;padding: 0;padding-left: 5px">
                        ...
                        <img src="/uploads/plateformes/plateforme_03.png" class="img-circle" width="20" height="20" style="float: left"> <h4  class="text-primary inline"><a href="">{{$projet->titre}}</a></h4>
                    </div>
