        ...
        <div class="col-md-12">
            <div class="content-panel">
                <table class="table table-striped table-advance table-hover">
                    <h4 style=""> Liste Type de démarrage <span class="pull-right"><a href="{{route('creerDemarrageProjet')}}" data-toggle="tooltip" data-placement="bottom" title="Ajouter!"><i class="fa fa-plus-circle fa-2x"></i></a></span></h4>
                    <hr>
                    <thead>
                    <tr>
                    ...
                    @foreach($listes as $object)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('editerdemarrageProjet',['id'=>$object->id])}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil fa-2x"></i></a>
