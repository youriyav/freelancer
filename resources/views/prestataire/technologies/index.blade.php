...
@section("mainEntete")
    <div class="col-lg-12 col-md-12" style="min-height: 120px;background: rgba(0,142 ,173 ,1) url('/img/back-header.png') repeat-x center top;" >
        ...
        <div class=" top-filter tfilter-box bottom" style="margin-bottom: 20px;">
            <div class="container ">
                <form action="" method="post" class="text-center center-block">
                    ...
                    <div   class="" >
                        ...
                        <div class="col-sm-4 form-group-lg" style="padding: 5px">
                            <select class="form-control" name="techno" id="techno" style="font-weight: bold">
                                <option value="0">Toutes les technologies</option>
                                @foreach($listeOfTechnologies as $techno)
                                    <option value="{{$techno->id}}" @isset($currentTechnologie) @if($currentTechnologie->id==$techno->id) selected style="font-weight: bold" @endif @endisset>{{$techno->libelle}}</option>
                                @endforeach
                            </select>
                        </div>
    ...
    <div class="row" style="margin-bottom: 10px;">
                            ...
                            <li class="list-group-item">
                                ...
                                <ul id="{{$plat->id}}" class="collapse @isset($currentPlateforme) @if($currentPlateforme->id==$plat->id) in @endif  @endisset">
                                    ...
                                    @foreach($plat->technologies as $techno)
                                        <li class=""  style="margin-left: 20px">
                                            <span><a href="@if($techno->slug) {{route('indexTechnoUser',['slugPlateforme'=>$plat->slug->content,'slugTechno'=>$techno->slug->content])}} @endif " @isset($currentTechnologie) @if($currentTechnologie->id==$techno->id)  style="font-weight: bold;font-size: 1.2em" @endif @endisset>{{$techno->libelle}}</a></span>
                                        </li>
                                    @endforeach
        ...
        <div class="col-lg-7 col-md-9">
            ...
            <div class="row" style="margin-top: 20px;padding: 5px">
                @if($currentPlateforme!=null && $currentTechnologie!=null)
