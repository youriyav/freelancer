        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    <tbody>
                    <tr>
                        <th colspan="2">Url (vous pouvez ajouter des liens des applications, sites etc.. dont vous avez eu à réaliser .)<button class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus-circle"></i> Ajouter</button></th>
                    </tr>
